...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   for (let i in objetoMisterioso) {
      if (objetoMisterioso.hasOwnProperty(i)) {
         return objetoMisterioso[i] * 5;
      }
   }
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   // Precio final ---> 8
   // Tu código:
   objetoProducto.calcularPrecioDescuento = function por () {
      let dis = this.precio * this.porcentajeDeDescuento;
      result = this.precio - dis;
      return result;
   }
